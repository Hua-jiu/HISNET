...
if __name__ == '__main__':
    ...
    # load net
    net = torchvision.models.mobilenet_v3_large(weights=torchvision.models.MobileNet_V3_Large_Weights.DEFAULT)
    # print(net)
    net.classifier[3] = torch.nn.Linear(net.classifier[3].in_features, num_class)
    net = net.to(device)
